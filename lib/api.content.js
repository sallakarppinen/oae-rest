 ...
 * @param  {Content}      callback.content    Content object representing the created content
 */
var createCollabsheet = module.exports.createCollabsheet = function(restCtx, displayName, description, visibility, managers, editors, viewers, folders, callback) {
    var params = {
 ...
 * @param  {Function}       callback            Standard callback method
 * @param  {Object}         callback.err        Error object containing error code and error message.
 * @param  {String}         callback.url        The URL where the etherpad or ethercalc instance for the collaborative document/spreadsheet is available.
 */
