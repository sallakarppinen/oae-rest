 ...
 */
const getWidgetManifests = module.exports.getWidgetManifests = function(restCtx, callback) {
 ...
 */
const getStaticBatch = module.exports.getStaticBatch = function(restCtx, files, callback) {
