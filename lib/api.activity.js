 ...
 * @param  {ActivityStream} callback.activityStream The stream of activities
 */
var getActivityStream = module.exports.getActivityStream = function(restCtx, resourceId, opts, callback) {
    var url = '/api/activity/' + RestUtil.encodeURIComponent(resourceId);
