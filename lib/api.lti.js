 ...
 */
var createLtiTool = module.exports.createLtiTool = function(restCtx, groupId, url, secret, key, displayName, description, callback) {
    var postData = {
        'url': url,
        'secret': secret,
        'key': key,
...
var deleteLtiTool = module.exports.deleteLtiTool = function(restCtx, groupId, toolId, callback) {
    return RestUtil.RestRequest(restCtx, '/api/lti/' + RestUtil.encodeURIComponent(groupId) + '/' + RestUtil.encodeURIComponent(toolId), 'DELETE', null, callback);
};
...
var getLtiTool = module.exports.getLtiTool = function(restCtx, groupId, toolId, callback) {
    return RestUtil.RestRequest(restCtx, '/api/lti/' + RestUtil.encodeURIComponent(groupId) + '/' + RestUtil.encodeURIComponent(toolId), 'GET', null, callback);
};
...
var getLtiTools = module.exports.getLtiTools = function(restCtx, groupId, callback) {
    ...
    RestUtil.RestRequest(restCtx, '/api/lti/' + RestUtil.encodeURIComponent(groupId), 'GET', null, callback);
};
