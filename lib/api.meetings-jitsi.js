 ...
 * @param {Object}          callback.err        Error object containing error code and error message
 */
var updateMembers = module.exports.updateMembers = function (restCtx, meetingId, updatedMembers, callback) {
    RestUtil.RestRequest(restCtx, '/api/meeting-jitsi/' + RestUtil.encodeURIComponent(meetingId) + '/members', 'PUT', updatedMembers, callback);
};
 ...
 */
var createComment = module.exports.createComment = function (restCtx, meetingId, body, replyTo, callback) {
    RestUtil.RestRequest(restCtx, '/api/meeting-jitsi/' + RestUtil.encodeURIComponent(meetingId) + '/messages', 'POST', {'body': body, 'replyTo': replyTo}, callback);
};
 ...
 */
var deleteComment = module.exports.deleteComment = function(restCtx, meetingId, created, callback) {
    RestUtil.RestRequest(restCtx, '/api/meeting-jitsi/' + RestUtil.encodeURIComponent(meetingId) + '/messages/' + RestUtil.encodeURIComponent(created), 'DELETE', null, callback);
};